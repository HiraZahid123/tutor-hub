...
<div class="flex items-center justify-center bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-blue-500/5 border border-blue-50/50">
        <div>
            <h2 class="text-center text-3xl font-black text-gray-900 tracking-tight leading-tight">Log in to your account</h2>
            <p class="mt-2.5 text-center text-sm text-gray-500 font-medium">
                Or <a href="{{ route('register') }}" class="font-bold text-blue-600 hover:text-blue-500">create a new account</a>
            </p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5 ml-1">
                        ...
                        <a href="#" class="text-[11px] font-bold text-blue-600 hover:text-blue-500 uppercase tracking-wider">Forgot password?</a>
                    </div>
